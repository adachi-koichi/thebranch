...
pytest_plugins = [
    'tests.workflow.e2e.step_defs.template_steps',
    'tests.workflow.e2e.step_defs.instance_steps',
    'tests.workflow.e2e.step_defs.task_steps',
]
...
@pytest.fixture
def workflow_template_named(bdd_context):
    """Get current template from BDD context"""
    if bdd_context.current_template_name:
        return bdd_context.templates.get(bdd_context.current_template_name)
    return None
